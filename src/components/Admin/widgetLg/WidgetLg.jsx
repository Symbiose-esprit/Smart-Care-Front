      ...
      <table className="widgetLgTable">
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img src={ouss} alt="" className="widgetLgImg" />
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img src={maryeem} alt="" className="widgetLgImg" />
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img src={amine} alt="" className="widgetLgImg" />
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img src={yasmine} alt="" className="widgetLgImg" />
