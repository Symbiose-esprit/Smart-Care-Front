                            ...
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li className="nav-item">
                                            <Link href="/client/appointments/appointment" activeClassName="active">
                                                <a onClick={toggleNavbar} className="nav-link">Appointment</a>
                                            </Link>
                                        </li>

                                        <li className="nav-item">
                                            <Link href="/client/appointments/schedule" activeClassName="active">
                                        ...
                                        <li className="nav-item">
                                            <Link href="/client/other/testimonials" activeClassName="active">
                                                <a onClick={toggleNavbar} className="nav-link">Testimonials</a>
                                            </Link>
                                        </li>

                                        <li className="nav-item">
                                            <Link href="/client/login/sign-up" activeClassName="active">
                                                <a onClick={toggleNavbar} className="nav-link">Sign Up</a>
                                            </Link>
                                        </li>

                                        <li className="nav-item">
                                            <Link href="/client/login/sign-in" activeClassName="active">
                                        ...
                                        <li className="nav-item">
                                            <Link href="/client/other/coming-soon" activeClassName="active">
                                                <a onClick={toggleNavbar} className="nav-link">Coming Soon</a>
                                            </Link>
                                        </li>

                                        <li className="nav-item">
                                            <Link href="/client/other/privacy-policy" activeClassName="active">
                                                <a onClick={toggleNavbar} className="nav-link">Privacy Policy</a>
                                            </Link>
                                        </li>

                                        <li className="nav-item">
                                            <Link href="/client/other/terms-condition" activeClassName="active">
                                ...
                                <li className="nav-item">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li className="nav-item">
                                            <Link href="/client/services/services" activeClassName="active">
                                                <a onClick={toggleNavbar} className="nav-link">Services</a>
                                            </Link>
                                        </li>

                                        <li className="nav-item">
                                            <Link href="/client/services/service-details" activeClassName="active">
                                ...
                                <li className="nav-item">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li className="nav-item">
                                            <Link href="/client/doctor/doctors" activeClassName="active">
                                                <a onClick={toggleNavbar} className="nav-link">Doctors</a>
                                            </Link>
                                        </li>

                                        <li className="nav-item">
                                            <Link href="/client/doctor/doctor-details" activeClassName="active">
                                ...
                                <li className="nav-item">
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <li className="nav-item">
                                            <Link href="/client/blog/blog-details" activeClassName="active">
